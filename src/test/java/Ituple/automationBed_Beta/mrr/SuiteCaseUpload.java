...
public class SuiteCaseUpload extends SuiteBase {
	...
	public void caseUpload(String UserId, String Password, String role, String programName, String client,
			String ExcelPath) throws Exception {
	...
	public void downloadTemplate(String UserId, String Password, String role, String programName, String client,
			String ExcelPath) throws Exception {
	...
	public void verifyUploadedCases(String UserId, String Password, String role, String programName, String client,
			String ExcelPath) throws Exception {
		Utils.uBase.getDriverInstance();
		Utils.uBase.setUrl("https://onesource-qa.garretsongroup.com/mrr-ui/grg.html");
		Utils.uBase.openUrl();
		...
		for (ArrayList<Object> reviewer : reviewerLogin) {
			...
			if (sortedCaseDetails.isWorksheetExist(worksheet)) {
				try {
					Object[][] CaseDetails = new ExcelUtility().getData(sortedCaseDetails,worksheet );
					ArrayList<Object> columnName = sortedCaseDetails.getRowAt(worksheet, 0);
					LoginPage login = PageFactory.initElements(Utils.uBase.driver, LoginPage.class);
					login.login((String) reviewer.get(1), (String) reviewer.get(2)).verifyLogin();
					...
					for (Object[] casedetails : CaseDetails) {
						String caseName=(String) casedetails[0];
					...
					AdvanceReporting.addLogs("fail", "failed", Constant.TestCase+"//failed");
					e.printStackTrace();
				}
