...
public class SpecificCase extends SuiteBase{
	...
	public void verifyInjuryDoneFunctionality(String UserId, String Password, String role, String programName, String client,String caseType,
				String caseName, String data) throws Exception{
			Utils.uBase.getDriverInstance();
			Utils.uBase.setUrl("https://onesource-development.garretsongroup.com/mrr-ui/grg.html");
			Utils.uBase.openUrl();
	...
	public void verifyCaseSubSections(String UserId, String Password, String role, String programName, String client,String caseType,
			String caseName, String data) throws Exception {
		...
		casePage.editCaseDetails(programName, client, caseName).openSection("Injury").editSection().saveSection();
